namespace NAMESPACE
{
	...
	COptionInvoke<void(__thiscall*)(oCMobContainer*, oCNpc*), bool> Ivk_oCMobContainer_Open(ZenDef<TInstance>(0x006843D0, 0x006B3FA0, 0x006C8470, 0x00726500), &Hook_oCMobContainer_Open, IvkEnabled(ENGINE), Settings::RemoveKeys);
	void __fastcall Hook_oCMobContainer_Open(oCMobContainer* _this, void* vtable, oCNpc* npc)
	{
		const bool removed = TryRemoveKey(npc, _this->keyInstance);
	...
	COptionInvoke<void(__thiscall*)(oCMobDoor*, oCNpc*), bool> Ivk_oCMobDoor_Open(ZenDef<TInstance>(0x00679250, 0x006A7890, 0x006BC3A0, 0x0071A430), &Hook_oCMobDoor_Open, IvkEnabled(ENGINE), Settings::RemoveKeys);
