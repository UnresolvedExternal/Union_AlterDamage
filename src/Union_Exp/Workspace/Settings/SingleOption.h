namespace NAMESPACE
{
	...
	public:
		...
		CSingleOption(CSingleOption&& right) :
			CSingleOptionBase{ std::move(right) },
	...
	public:
		CActiveValue(const T& value = {}) : value{ value } { }
		CActiveValue(CActiveValue&&) = default;
		operator T() const { return value; }

		CActiveValue& operator=(const T& y)
		{
		...
		CDelegateContainer<void(const CActiveValue&)> onChange;
	};
