namespace NAMESPACE
{
	...
	CInvoke<void(__thiscall*)(zCVob*, zCWorld*)> Ivk_zCVob_ThisVobAddedToWorld(ZenDef<TInstance>(0x005D66B0, 0x005F5BF0, 0x005FAE50, 0x00601C80), &Hook_zCVob_ThisVobAddedToWorld, IvkEnabled(CurrentEngine));
	...
	CInvoke<void(__thiscall*)(zCVob*, zCWorld*)> Ivk_zCVob_ThisVobRemovedFromWorld(ZenDef<TInstance>(0x005D66D0, 0x005F5C10, 0x005FAE70, 0x00601CA0), &Hook_zCVob_ThisVobRemovedFromWorld, IvkEnabled(CurrentEngine));
	...
	CInvoke<int(__thiscall*)(oCNpc*, oCItem*)> Ivk_oCNpc_UseItem(ZenDef<TInstance>(0x00698810, 0x006CA590, 0x006DD450, 0x0073BC10), &Hook_oCNpc_UseItem, IvkEnabled(CurrentEngine));
