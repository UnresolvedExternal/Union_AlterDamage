...
namespace Gothic_II_Addon {
  ...
  oCNpcFocus*& oCNpcFocus::focus             = *(oCNpcFocus**)0x00AB06F8;
  ...
  zCFFT& zCFFT::s_fft     = *(zCFFT*)0x008D8558;
  ...
  zVEC3*& zCProgMeshProto::s_posCacheList                   = *(zVEC3**)0x0095EA10;
  ...
  zCVertexBuffer*& zD3D_alphaPoly::vertexbuffer                                 = *(zCVertexBuffer**)0x009FCA04;
