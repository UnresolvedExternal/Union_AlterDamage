...
namespace Gothic_II_Classic {
  ...
  oCNpcFocus*& oCNpcFocus::focus             = *(oCNpcFocus**)0x00981250;
  ...
  zCCamera*& zCCamera::activeCam                                                     = *(zCCamera**)0x008C9908;
  ...
  zCVertexBuffer*& zD3D_alphaPoly::vertexbuffer                                 = *(zCVertexBuffer**)0x009D1B5C;
