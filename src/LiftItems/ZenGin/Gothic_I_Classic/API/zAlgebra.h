...
namespace Gothic_I_Classic {
  ...
  public:
    ...
    void PostRotateX( const float& a0 ) zCall( 0x00507A40 );
    void PostRotateY( const float& a0 ) zCall( 0x00507A90 );
    void PostRotateZ( const float& a0 ) zCall( 0x00507AE0 );
  ...
  public:
    ...
    void Squad( const float& a0, const zCQuat a1, const zCQuat& a2, const zCQuat a3, const zCQuat& a4 ) zCall( 0x00509300 );
