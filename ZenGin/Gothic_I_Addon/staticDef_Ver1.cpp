...
namespace Gothic_I_Addon {
  ...
  oCNpcFocus*& oCNpcFocus::focus      = *(oCNpcFocus**)0x00920BA8;
  ...
  zCCamera*& zCCamera::activeCam                         = *(zCCamera**)0x008B8ED8;
  ...
  unsigned int& zCMgcEigenD::error                   = *(unsigned int*)0x0055A180;
  const unsigned int& zCMgcEigenD::invalid_size      = *(const unsigned int*)0x0055A180;
  const unsigned int& zCMgcEigenD::allocation_failed = *(const unsigned int*)0x0055A180;
  const unsigned int& zCMgcEigenD::ql_exceeded       = *(const unsigned int*)0x0055A180;
  ...
  zCVertexBuffer*& zD3D_alphaPoly::vertexbuffer                                 = *(zCVertexBuffer**)0x00971FC4;
