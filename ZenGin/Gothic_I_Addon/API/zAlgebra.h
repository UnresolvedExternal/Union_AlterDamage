...
namespace Gothic_I_Addon {
  ...
  public:
    ...
    void PostRotateX( const float& a0 ) zCall( 0x0051C220 );
    void PostRotateY( const float& a0 ) zCall( 0x0051C270 );
    void PostRotateZ( const float& a0 ) zCall( 0x0051C2C0 );
  ...
  public:
    ...
    void Slerp( const float& a0, const zCQuat a1, const zCQuat& a2 )                                    zCall( 0x0051DA90 );
    void Lerp( const float& a0, const zCQuat a1, const zCQuat& a2 )                                     zCall( 0x0051DCB0 );
    void Squad( const float& a0, const zCQuat a1, const zCQuat& a2, const zCQuat a3, const zCQuat& a4 ) zCall( 0x0051DE30 );
