...
#ifndef __ZSPARSE_ARRAY_H__
#define __ZSPARSE_ARRAY_H__
...
namespace Gothic_II_Addon {
  ...
  public:
    ...
    zCSparseArrayBase( unsigned long )                                     zCall( 0x005EF2B0 );
