...
namespace Gothic_II_Classic {
  ...
  public:
    ...
    void PostRotateX( const float& a0 ) zCall( 0x00514960 );
    void PostRotateY( const float& a0 ) zCall( 0x005149B0 );
    void PostRotateZ( const float& a0 ) zCall( 0x00514A00 );
  ...
  public:
    ...
    void Slerp( const float& a0, const zCQuat a1, const zCQuat& a2 )                                    zCall( 0x00515F40 );
    void Lerp( const float& a0, const zCQuat a1, const zCQuat& a2 )                                     zCall( 0x00516120 );
    void Squad( const float& a0, const zCQuat a1, const zCQuat& a2, const zCQuat a3, const zCQuat& a4 ) zCall( 0x00516220 );
